...
async def test_ai_cascade_tier_fallback():
    ...
    with mock.patch("backend.config.settings.MODAL_API_TOKEN", "123"), \
         mock.patch("backend.config.settings.GROQ_API_KEY", "123"), \
         mock.patch("backend.config.settings.GEMINI_API_KEY", "123"), \
         mock.patch("backend.config.settings.COMPUTE_PROVIDER", None), \
         mock.patch("backend.services.ai_cascade.facade.settings.MODAL_API_TOKEN", "123"), \
         mock.patch("backend.services.ai_cascade.facade.settings.GROQ_API_KEY", "123"), \
         mock.patch("backend.services.ai_cascade.facade.settings.GEMINI_API_KEY", "123"), \
         mock.patch("backend.services.ai_cascade.facade.settings.COMPUTE_PROVIDER", None):
