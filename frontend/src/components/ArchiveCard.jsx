...
export default function ArchiveCard({ item, isActive, opacity, blur, onClick }) {
  ...
  return (
    ...
    >
      ...
      <div className="archive-card-metadata" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap', position: 'relative', zIndex: 1, borderTop: '1px solid rgba(244,239,235,0.06)', paddingTop: '0.875rem' }}>
